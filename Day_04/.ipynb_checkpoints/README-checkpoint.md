...
├── 4_AI_in_Healthcare_Building_a_Life_Saving_Heart_Disease_Predictor.ipynb  # Reference notebook
├── 4_AI_in_Healthcare_Local_Working.ipynb                             # Local working version
├── Assignment/
│   └── Assignment_Heart_Disease.ipynb                                 # Main assignment implementation
└── data/
