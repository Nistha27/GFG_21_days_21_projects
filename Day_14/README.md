...
├── 14_Build_Your_Own_GPT_Creating_a_Custom_Text_Generation_Engine.ipynb # Main tutorial notebook
└── Assignment_Python_Code_Focused_GPT2_Inference.ipynb                   # Assignment solution notebook
```
