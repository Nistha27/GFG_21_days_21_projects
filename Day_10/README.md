...
├── Creative_AI_Generating_Art_with_Neural_Style_Transfer.ipynb # Main tutorial notebook
├── gender-classification-with-mobilenet.ipynb                   # Gender classification notebook
├── Assignment_Gender_Style_Transfer.ipynb                       # Assignment solution notebook
├── Face-Generator-with-GAN-main/
│   ├── README.md                                                # Face GAN documentation
│   ├── Face_Generators.ipynb                                    # Face generation notebook
│   ├── face-generator-with-gan.ipynb                            # GAN implementation
│   ├── generator_100.h5                                         # Generator model (epoch 100)
│   ├── generator_200.h5                                         # Generator model (epoch 200)
│   ├── generator_300.h5                                         # Generator model (epoch 300)
│   ├── generator_400.h5                                         # Generator model (epoch 400)
│   ├── generator_500.h5                                         # Generator model (epoch 500)
│   ├── generator_600.h5                                         # Generator model (epoch 600)
│   └── generator_700.h5                                         # Generator model (epoch 700)
└── Gender-Style-Transfer-main/
    ├── README.md                                                # Gender style transfer documentation
    ├── gender_vec.npy                                           # Gender vector data
    ├── female_images_data.csv                                   # Female images dataset
    ├── male_images_data.csv                                     # Male images dataset
    └── grid_face_transformation.gif                             # Transformation visualization
```
