...
├── 2_Cracking_the_Code_An_Inside_Look_at_Netflix's_Content_Strategy.ipynb  # Reference notebook
└── Assignment_Netflix_Content_Analysis.ipynb          # Main analysis assignment
```
